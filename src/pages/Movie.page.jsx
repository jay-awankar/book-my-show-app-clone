  ...
  useEffect(() => {
    const requestCast = async () => {
      const getCast = await axios.get(
        `https://api.themoviedb.org/3/movie/${id}/credits?api_key=38858108da13da79e7cf650a5cd7c46c`
      );
  ...
  useEffect(() => {
    const requestSimilarMovies = async () => {
      const getSimilarMovies = await axios.get(
        `https://api.themoviedb.org/3/movie/${id}/similar?api_key=38858108da13da79e7cf650a5cd7c46c`
      );
  ...
  useEffect(() => {
    const requestRecommededMovies = async () => {
      const getRecommendedMovies = await axios.get(
        `https://api.themoviedb.org/3/movie/${id}/recommendations?api_key=38858108da13da79e7cf650a5cd7c46c`
      );
  ...
  useEffect(() => {
    const requestMovie = async () => {
      const getMovieDate = await axios.get(
        `https://api.themoviedb.org/3/movie/${id}?api_key=38858108da13da79e7cf650a5cd7c46c`
      );
